...
cpuinfo.get_cpu_info().items()}, orient='index')
...
print('This expriment is about verifying that the minimum of the subadditivity slack of a cut generating function is no smaller than -0.01.')
